...
public class GarageFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        toggleGarage = view.findViewById(R.id.toggleGarage);
        ...
        toggleGarage.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton arg0, boolean isChecked) {
                if(isChecked) {
                    textViewGarage.setText("Open");
                    AndroidNetworking.post(IConstants.SERVER_URL + "/garageOnOff").addBodyParameter("garage", "ON")
                            ...
                            .getAsJSONObject(new JSONObjectRequestListener() {
                                ...
                                public void onResponse(JSONObject response) {
                                    try {
                                        String state = response.getString("doorStatus");
                                        if(state.equals("OFF")) {
...
//                        Toast.makeText(getApplication(), anError.getMessage(), Toast.LENGTH_SHORT).show();
                    ...
                    textViewGarage.setText("Closed");
                    AndroidNetworking.post(IConstants.SERVER_URL + "/garageOnOff").addBodyParameter("garage", "OFF")
                            .setPriority(Priority.MEDIUM)
                            .build()
                            .getAsJSONObject(new JSONObjectRequestListener() {
                                @Override
